...
export const chatbotFaqs: KnowledgeFaq[] = [
  ...
  },
  {
    ...
    a: "Chatbot builds are quoted per project, since scope varies a lot between a simple FAQ assistant and a full lead-qualifying bot with CRM integration. Share your website and what you want the bot to handle, and we'll send a fixed quote — no obligation.",
  },
  {
